...
import org.torusresearch.fetchnodedetails.fndbase.SapphireConfig;
...
public class Utils {
    ...
    public static NodeDetails NODE_DETAILS_SAPPHIRE_MAINNET = new NodeDetails("1", new String[]{"https://node-1.node.web3auth.io/sss/jrpc", "https://node-2.node.web3auth.io/sss/jrpc", "https://node-3.node.web3auth.io/sss/jrpc", "https://node-4.node.web3auth.io/sss/jrpc", "https://node-5.node.web3auth.io/sss/jrpc"},
            ...
            new BigInteger[]{new BigInteger("1"), new BigInteger("2"), new BigInteger("3"), new BigInteger("4"), new BigInteger("5")},
            SapphireConfig.SapphireMainnetNodePub.toArray(new TorusNodePub[0]),
            false);
    ...
    public static NodeDetails NODE_DETAILS_SAPPHIRE_DEVNET = new NodeDetails("1", new String[]{"https://node-1.dev-node.web3auth.io/sss/jrpc", "https://node-2.dev-node.web3auth.io/sss/jrpc", "https://node-3.dev-node.web3auth.io/sss/jrpc", "https://node-4.dev-node.web3auth.io/sss/jrpc", "https://node-5.dev-node.web3auth.io/sss/jrpc"},
            ...
            new BigInteger[]{new BigInteger("1"), new BigInteger("2"), new BigInteger("3"), new BigInteger("4"), new BigInteger("5")},
            SapphireConfig.SapphireDevnetNodePub.toArray(new TorusNodePub[0]),
            false);
    public static final Map<BuildEnv, String> CITADEL_SERVER_MAP = new HashMap<BuildEnv, String>() {
        {
            put(BuildEnv.PRODUCTION, "https://api.web3auth.io/citadel-service");
            put(BuildEnv.DEVELOPMENT, "https://api-develop.web3auth.io/citadel-service");
            put(BuildEnv.STAGING, "https://api.web3auth.io/citadel-service");
            put(BuildEnv.TESTING, "https://api-develop.web3auth.io/citadel-service");
        }
    };

    public static final Map<BuildEnv, String> DASHBOARD_PUBLIC_API_MAP = new HashMap<BuildEnv, String>() {
        {
            put(BuildEnv.PRODUCTION, "https://api.web3auth.io/signer-service");
            put(BuildEnv.DEVELOPMENT, "https://api-develop.web3auth.io/signer-service");
            put(BuildEnv.STAGING, "https://api.web3auth.io/signer-service");
            put(BuildEnv.TESTING, "https://api-develop.web3auth.io/signer-service");
        }
    };

    public static final Map<BuildEnv, String> LEGACY_METADATA_MAP = new HashMap<BuildEnv, String>() {
        {
            put(BuildEnv.PRODUCTION, "https://api.web3auth.io/metadata-service");
            put(BuildEnv.DEVELOPMENT, "https://api-develop.web3auth.io/metadata-service");
            put(BuildEnv.STAGING, "https://api.web3auth.io/metadata-service");
            put(BuildEnv.TESTING, "https://api-develop.web3auth.io/metadata-service");
        }
    };

    public static final Map<BuildEnv, String> FND_SERVER_MAP = new HashMap<BuildEnv, String>() {
        {
            put(BuildEnv.PRODUCTION, "https://api.web3auth.io/fnd-service");
            put(BuildEnv.DEVELOPMENT, "https://api-develop.web3auth.io/fnd-service");
            put(BuildEnv.STAGING, "https://api.web3auth.io/fnd-service");
            put(BuildEnv.TESTING, "https://api-develop.web3auth.io/fnd-service");
        }
    };

    public static final Map<BuildEnv, String> STORAGE_SERVER_MAP = new HashMap<BuildEnv, String>() {
        {
            put(BuildEnv.PRODUCTION, "https://api.web3auth.io/session-service");
            put(BuildEnv.DEVELOPMENT, "https://api-develop.web3auth.io/session-service");
            put(BuildEnv.STAGING, "https://api.web3auth.io/session-service");
            put(BuildEnv.TESTING, "https://api-develop.web3auth.io/session-service");
        }
    };

    public static final Map<BuildEnv, String> STORAGE_SERVER_SOCKET_URL_MAP = new HashMap<BuildEnv, String>() {
        {
            put(BuildEnv.PRODUCTION, "https://session.web3auth.io");
            put(BuildEnv.DEVELOPMENT, "https://develop-session.web3auth.io");
            put(BuildEnv.STAGING, "https://session.web3auth.io");
            put(BuildEnv.TESTING, "https://develop-session.web3auth.io");
        }
    };
    ...
    public static HashMap<String, LegacyNetworkMigrationInfo> LEGACY_NETWORKS_ROUTE_MAP = new HashMap<String, LegacyNetworkMigrationInfo>() {
        {
            put(LegacyNetwork.AQUA.toString(), new LegacyNetworkMigrationInfo("aqua", Web3AuthNetwork.SAPPHIRE_MAINNET));
            put(LegacyNetwork.CELESTE.toString(), new LegacyNetworkMigrationInfo("celeste", Web3AuthNetwork.SAPPHIRE_MAINNET));
            put(LegacyNetwork.CYAN.toString(), new LegacyNetworkMigrationInfo("cyan", Web3AuthNetwork.SAPPHIRE_MAINNET));
            put(LegacyNetwork.MAINNET.toString(), new LegacyNetworkMigrationInfo("mainnet", Web3AuthNetwork.SAPPHIRE_MAINNET));
            put(LegacyNetwork.TESTNET.toString(), new LegacyNetworkMigrationInfo("teal", Web3AuthNetwork.SAPPHIRE_DEVNET));
        }
    };

    public static NodeDetails fetchLocalConfig(Web3AuthNetwork network) {
        return fetchLocalConfig(network, KeyType.SECP256K1, SigType.ECDSA_SECP256K1);
    }

    @SuppressWarnings("unused")
    public static NodeDetails fetchLocalConfig(Web3AuthNetwork network, KeyType keyType, SigType sigType) {
